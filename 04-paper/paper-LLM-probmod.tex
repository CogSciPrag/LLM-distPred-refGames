...
\begin{figure}[t]
  \centering
  \includegraphics[width = 0.95\textwidth]{pics-final/condition-item-level-prediction.png}
  \caption{
...
Finally, Section~\ref{sec:gener-other-llm} explores whether previous results generalize to other LLM backends by investigating different versions of LLaMA2 \citep{TouvronLavril2023:LLaMA:-Open-and}.\footnote{
  All data and code is available at this OSF repository:  \href{https://osf.io/f6j3a/?view_only=5e820cc8bbee4549aed58dc252ba61b9}{https://osf.io/f6j3a/?view\_only=5e820cc8bbee4549aed58dc252ba61b9}.
}
...
\begin{figure}
  ...
  \includegraphics[width = 0.8\textwidth]{pics-final/reference-game.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width = 0.9 \textwidth]{pics-final/RSA-example.png}
  \caption{
...
\begin{figure}[t]
  \centering
    ...
    \includegraphics[width=0.9\linewidth]{pics-final/GPT-PPC-alpha-eps-model.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{pics-final/GPT-closeness-target-by-alpha-item-level.pdf}
  \caption{
...
\begin{figure}[t]
  ...
  \includegraphics[width = 0.9\linewidth]{pics-final/GPT-item-combined-obs-pred.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{pics-final/measures-overview.png}
  \caption{
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.9\textwidth]{pics-final/vPPC_all_LLaMA_models.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width = 0.8\textwidth]{pics-final/refgame-production.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width = 0.8\textwidth]{pics-final/refgame-interpretation.png}
