...
While it may be the case that, in producing an item-level prediction, the internal computation of a powerful LLM is informed by computations that incorporate abstract knowledge roughly corresponding to the condition-level, the atomic predictions accessible to the common user are specific to each individual string tested, thus raising concerns about robustness of predictions under perturbations of input prompts \mf{cite}.
...
To address this question, we assessed item-level scores $\text{S}_{kl}$ from the text-davinci-003 instance GPT-3.5 August 2023 \citep{BrownMann2020:Language-Models} for a text-based version of the reference game from Section~\ref{experiment-reference-games}.
% \footnote{
...
\begin{align*}
  ...
  = \epsilon_{c} \  P_{\text{item}}^{\text{LLM}}\left ( y_{kl} \mid C; \alpha_{c}, \epsilon_{c} \right ) \ \ + \ \ \nicefrac{\epsilon_{c}}{3}   \,.
\end{align*}
%
...
\begin{tabular}{cllllcrlcrlc}
  ...
  \textcolor{shimmer-main}{$\times$} & L2-hf-7b    & item  & ---         & prd. & 1.09  & 1.30   & 1.51   & 0.00 & 0.02 & 0.06 & 0.00 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-7b    & item  & ---         & int. & 1.90  & 2.52   & 3.13   & 0.00 & 0.04 & 0.12 & 0.00 \\
  \textcolor{fern-main}{$\checkmark$} & L2-hf-7b    & cond. & avg. scores & prd. & 9.65  & 11.50  & 13.62  & 0.08 & 0.12 & 0.16 & 0.48 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-7b    & cond. & avg. scores & int. & 6.80  & 7.96   & 9.14   & 0.00 & 0.02 & 0.05 & 0.00 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-7b    & cond. & avg. prob.  & prd. & 4.98  & 16.44  & 33.06  & 0.06 & 0.10 & 0.13 & 0.00 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-7b    & cond. & avg. prob.  & int. & 20.06 & 79.30  & 163.94 & 0.00 & 0.01 & 0.04 & 0.00 \\
  \textcolor{fern-main}{$\checkmark$} & L2-hf-7b    & cond. & avg. WTA    & prd. & 4.17  & 4.96   & 5.85   & 0.07 & 0.12 & 0.16 & 0.48 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-7b    & cond. & avg. WTA    & int. & 0.87  & 1.02   & 1.18   & 0.00 & 0.02 & 0.05 & 0.00 \\ \addlinespace[0.5em]
  \textcolor{shimmer-main}{$\times$} & L2-hf-13b   & item  & ---         & prd. & 1.37  & 1.91   & 2.47   & 0.00 & 0.07 & 0.12 & 0.00 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-13b   & item  & ---         & int. & 2.13  & 2.90   & 3.69   & 0.00 & 0.05 & 0.14 & 0.00 \\
  \textcolor{fern-main}{$\checkmark$} & L2-hf-13b   & cond. & avg. scores & prd. & 13.73 & 16.32  & 19.10  & 0.08 & 0.12 & 0.16 & 0.50 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-13b   & cond. & avg. scores & int. & 7.73  & 9.11   & 10.42  & 0.00 & 0.02 & 0.05 & 0.00 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-13b   & cond. & avg. prob.  & prd. & 69.84 & 185.80 & 360.44 & 0.06 & 0.09 & 0.13 & 0.00 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-13b   & cond. & avg. prob.  & int. & 13.63 & 39.72  & 88.28  & 0.00 & 0.02 & 0.05 & 0.00 \\
  \textcolor{fern-main}{$\checkmark$} & L2-hf-13b   & cond. & avg. WTA    & prd. & 2.28  & 2.70   & 3.18   & 0.08 & 0.12 & 0.16 & 0.51 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-13b   & cond. & avg. WTA    & int. & 0.78  & 0.94   & 1.12   & 0.00 & 0.03 & 0.07 & 0.03 \\ \addlinespace[0.5em]
  \textcolor{shimmer-main}{$\times$} & L2-hf-70b   & item  & ---         & prd. & 1.53  & 1.86   & 2.22   & 0.00 & 0.03 & 0.07 & 0.00 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-70b   & item  & ---         & int. & 3.20  & 4.01   & 4.74   & 0.00 & 0.03 & 0.08 & 0.00 \\
  \textcolor{fern-main}{$\checkmark$} & L2-hf-70b   & cond. & avg. scores & prd. & 44.57 & 53.17  & 62.44  & 0.08 & 0.12 & 0.17 & 0.48 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-70b   & cond. & avg. scores & int. & 6.86  & 8.14   & 9.32   & 0.00 & 0.02 & 0.05 & 0.00 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-70b   & cond. & avg. prob.  & prd. & 10.51 & 26.59  & 45.73  & 0.07 & 0.10 & 0.14 & 0.00 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-70b   & cond. & avg. prob.  & int. & 10.86 & 23.63  & 42.16  & 0.00 & 0.03 & 0.09 & 0.00 \\
  \textcolor{fern-main}{$\checkmark$} & L2-hf-70b   & cond. & avg. WTA    & prd. & 5.88  & 7.03   & 8.19   & 0.08 & 0.12 & 0.17 & 0.50 \\
  \textcolor{shimmer-main}{$\times$} & L2-hf-70b   & cond. & avg. WTA    & int. & 0.55  & 0.68   & 0.81   & 0.00 & 0.03 & 0.07 & 0.04 \\ \addlinespace[0.5em]
