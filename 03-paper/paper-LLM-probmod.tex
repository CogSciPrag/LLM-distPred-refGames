...
To obtain data for this investigation, we subjected human participants and an LLM (OpenAI's GPT-3.5 model \mf{add ref}) to the same forced-choice task, a simple reference game \citep{FrankGoodman2012:Predicting-Prag}.
