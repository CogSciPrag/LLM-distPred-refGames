...
The usual Bayesian summary statistics for posteriors over model parameters are shown in Figure~XYZ. \mf{TODO: make and include figure}
...
A first important conclusion from these results is that there is at least one model which is able to recover the patterns in the data.
...
\begin{itemize}
  \item make plot for posterior parameters
  \item non-triviality of intermediate-scope model
  \item maybe: comparison to RSA
