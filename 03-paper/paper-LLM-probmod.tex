...
We see that the RSA model passes a ``visual posterior predictive check'' \citep{Kruschke2011:Doing-Bayesian-} for both conditions, in the sense that, when trained on the data, the predictions the model would generate include the observed choice rates for each answer option.
...
This is clearly not the case for the RSA model.
