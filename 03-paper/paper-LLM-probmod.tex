...
\mf{describe high-level results here}.

The paper is structured as follows.
Section~\ref{motivation} further motivates the desire to assess quantitative information from LLMs, and it introduces the distinction between item-level and condition-level predictions.
...
\mf{maybe insert formal definition of BPPPV?}
